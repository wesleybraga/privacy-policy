...
- **Nenhum Dado Pessoal Identificável:** O aplicativo não exige criação de conta, login, fornecimento de nome, e-mail, telefone, CPF ou dados bancários.
- **Sem Venda ou Compartilhamento:** Não monitoramos seus hábitos individuais de consumo de mídia para venda a terceiros ou corretores de dados.

---

### 3. Dados Salvos Localmente no Dispositivo
Para assegurar o funcionamento das funcionalidades básicas do reprodutor, os seguintes dados são armazenados **exclusivamente na memória interna local do seu aparelho**:
- **Listas e URLs de Reprodução:** Links e listas inseridos manualmente pelo usuário.
- **Favoritos e Histórico:** Itens marcados como favoritos e histórico recente para permitir a continuidade da navegação.
- **Preferências do Usuário:** Ajustes de interface, proporção de tela e configurações de reprodução.

> **Atenção:** Esses dados jamais são enviados para servidores externos operados por nós. Ao desinstalar o aplicativo ou limpar o armazenamento no sistema Android, todos os registros locais são permanentemente removidos.
...
### 5. Serviços e Bibliotecas de Terceiros
O aplicativo pode fazer uso de componentes essenciais da plataforma Android, tais como os serviços do Google Play (Google Cast SDK para transmissão de tela). Tais serviços podem coletar identificadores técnicos do dispositivo e dados de diagnóstico conforme regidos pelas políticas de privacidade do próprio Google.
...
### 7. Contato e Suporte
Caso você tenha qualquer dúvida sobre esta Política de Privacidade ou sobre o aplicativo, entre em contato através do nosso canal de suporte:  
📧 **bragaads.wesley@gmail.com**
